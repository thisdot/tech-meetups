Here you will find a list of different tech meetups that cover a vast array of different topics.
...
- [Angular Toronto](https://www.meetup.com/angulartoronto) - Angular 2+ meetup to all things Angular-related (NgRx, NestJS, TypeScript, etc).
